...
## Overview
The AI Chat application provides multi-model AI conversations with document upload and web search capabilities.

## Features

### 1. **Multi-Model Support**
- **Gemini 2.5 Flash Lite**: Fast, efficient responses
...
5. **Session Management**: Create new sessions for different topics
